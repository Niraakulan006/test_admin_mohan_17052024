                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-8" >
                                <h5 class="text-white">godown Details</h5>
                            </div>
                            <?php
                                $access_error = "";
                                ...
                                <div class="col-lg-3 col-md-4 col-6">
                                    <div class="form-group">
                                        <div class="form-label-group in-border">
                                            <input type="text" id="search_text" name="search_text" class="form-control shadow-none" placeholder="Search By godown Name" required onKeyUp="Javascript:table_listing_records_filter();">
                                            <label>Search By godown</label>
                                        </div>
                                    </div>
                                </div>
                            </div> 
