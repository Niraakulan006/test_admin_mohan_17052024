<?php 
    ...
    $cancelled_bill = $obj->getAllRecords($GLOBALS['suspense_voucher_table'], 'deleted', 1);
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-8">
                                <h5 class="text-white">Suspense voucher Details</h5>
                            </div>
                            <?php
                                $access_error = "";
...
<script>
    $(document).ready(function(){
        ...
        $("#suspense_voucher").addClass("active");
