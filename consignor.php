                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-8">
                                <h5 class="text-white">Consignor Details</h5>
                            </div>
                            <?php  $access_error = "";
                                    ...
                                    <div class="d-flex float-right">
                                        <div class="form-group">
                                            <div class="form-label-group in-border pb-2">
                                                <input type="text" id="search_text" name="search_text" class="form-control shadow-none" placeholder="Search By Consignor"  onKeyUp="Javascript:table_listing_records_filter();" required>
                                                <label>Search By Consignor</label>
                                            </div>
                                        </div>
                                        <div class="pl-2">
...
<script>
    ...
    function ExcelDownload() {
        ...
        url = "consignor_download.php?search_text="+search_text;
