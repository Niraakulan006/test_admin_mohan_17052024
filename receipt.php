<?php 
    ...
    // echo $creator_name = $GLOBALS['creator_name']."dsahihdkashdoi";
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-8">
                                <h5 class="text-white">Receipt Details</h5>
                            </div>
                            <?php
                                $access_error = "";
                    ...
                    <div class="poppins smallfnt">
                        <form name="table_listing_form" method="post">
                                <div class="row justify-content-end p-2">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-12 party_display d-none">
                                        <div class="form-group pb-2">
                                            <div class="form-label-group in-border">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-12">
                                        <div class="form-group pb-2">
                                            <div class="form-label-group in-border mb-0">
                                                <select name="filter_lr_id" class="select2 select2-danger smallfnt" data-dropdown-css-class="select2 select2-danger" onchange="Javascript:table_listing_records_filter();">
                                                    <option value="">Select</option>
