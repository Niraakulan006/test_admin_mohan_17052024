                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-8">
                                <h5 class="text-white">LR Product Details</h5>
                            </div>
                            <?php
                                $access_error = "";
                                ...
                                <div class="col-lg-3 col-md-4 col-6">
                                    <div class="form-group">
                                        <div class="form-label-group in-border pb-2">
                                            <input type="text" id="search_text" name="search_text" class="form-control shadow-none" placeholder="Search By Unit Name"  onKeyUp="Javascript:table_listing_records_filter();" required>
                                            <label>Search By LR Product</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
