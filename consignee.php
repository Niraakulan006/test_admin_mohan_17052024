                                    ...
                                    <div class="d-flex float-right">
                                        <div class="form-group">
                                            <div class="form-label-group in-border pb-2">
                                                <input type="text" id="search_text" name="search_text" class="form-control shadow-none" placeholder="Search By Consignee"  onKeyUp="Javascript:table_listing_records_filter();" required>
                                                <label>Search By Consignee</label>
                                            </div>
                                        </div>
                                        <div class="pl-2">
                                            <!-- <button class="btn btn-success float-right py-2" style="font-size:11px;" type="button" onClick="window.open('consignee_download.php','_self');"> <i class="fa fa-cloud-download"></i> Excel Download </button> -->
                                              <button class="btn btn-success float-right py-2" style="font-size:11px;" type="button" onclick="Javascript:ExcelDownload();"> <i class="fa fa-cloud-download"></i> Excel Download </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function ExcelDownload() {
        ...
        url = "consignee_download.php?search_text="+search_text;
