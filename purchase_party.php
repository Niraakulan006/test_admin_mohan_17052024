                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-8">
                                <h5 class="text-white">Purchase Party Details</h5>
                            </div>
                            <?php
                                $access_error = "";
                            ...
                            <div class="row justify-content-end mt-3 mr-1">
                                <?php if($party_count > 0) { ?>
                                    <div class="col-lg-4 col-md-4 col-6 text-right">
                                        ...
                                        <button class="btn btn-primary py-2 me-2" style="font-size:12px; width:75px;" type="button" onclick="Javascript:PrintPurchaseParty('');">
                                            <i class="fa fa-print"></i> Print
                                        </button>
                                        <button class="btn btn-info py-2" style="font-size:12px; width:75px;" type="button" onclick="Javascript:PrintPurchaseParty('D');">
                                ...
                                <div class="col-lg-4 col-md-4 col-6">
                                    <div class="form-group">
                                        <div class="form-label-group in-border pb-2">
                                            <input type="text" id="search_text" name="search_text" class="form-control shadow-none" placeholder="Search By Party Name"  onKeyUp="Javascript:table_listing_records_filter();" required>
...
<script>
    $(document).ready(function(){
        ...
        $("#purchase_party").addClass("active");
...
<script type="text/javascript">
    ...
    function PrintPurchaseParty(from) {
        var search_text = ""; var url = "";
        search_text = jQuery('input[name="search_text"]').val();
