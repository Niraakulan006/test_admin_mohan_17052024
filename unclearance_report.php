<?php 
    ...
    $total_records_list = $obj->getUnClearanceReportList($bill_company_id,$organization_id, $from_branch_id, $to_branch_id,$consignee_id,$consignor_id,$bill_type,'',$from_date, $to_date,'');
?>
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-8">
                                <h5 class="text-white">UnClearance Report</h5>
                            </div>
                        </div>
                    </div>
                       ...
                       <form name="report_form" method="post">
                            ...
                            <div class="row px-2 mt-3">
                                ...
                                <div class="col-sm-3 col-lg-2 form-group">
                                    <button type="button" class="btn btn-success" type="button" onClick="open_order_report('<?php echo $from_branch_id; ?>','<?php echo $to_branch_id; ?>','<?php echo $from_date; ?>','<?php echo $to_date; ?>','<?php echo $bill_type; ?>','<?php echo $consignee_id; ?>','<?php echo $consignor_id; ?>')"> <i class="fa fa-download"></i> Print </button>
                                                ...
                                                <?php
                                                    ...
                                                    if(!empty($total_records_list)) {
                                                        ...
                                                        foreach($total_records_list as $key => $data) {
                                                            $index = $key + 1;$account_party_name = "";
...
<script>
    $(document).ready(function(){
        ...
        $("#unclearance_report").addClass("active");
...
<script>
     ...
     <script>
        function open_order_report(from_branch_id,to_branch_id,from_date,to_date,bill_type,consignee_id,consignor_id){
            var url = "reports/rpt_unclearance_report.php?from_date="+ from_date +"&to_date="+ to_date +"&from_branch_id="+ from_branch_id +"&to_branch_id="+ to_branch_id +"&bill_type="+ bill_type +"&consignee_id="+ consignee_id +"&consignor_id="+ consignor_id;
