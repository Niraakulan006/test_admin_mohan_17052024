<?php 
    ...
    $payment_list =array();
    $payment_list = $obj->getPaymentReportList($from_date,$to_date,$filter_bill_type,$filter_party_id,$filter_payment_mode_id,$filter_bank_id,$filter_category_id);
                      ...
                      <div class="card-header">
                        <div class="row p-2">
                            <div class="col-lg-8 col-md-8 col-8">
                                <h5 class="text-white">Payment Report</h5>
                            </div>
                        </div>
                    </div>
                                                            ...
                                                            <td>
                                                                ...
                                                                if($info['bill_type'] == "Expense") {
                                                                    ...
                                                                    if(!empty($info['party_name']) && $info['party_name'] != $GLOBALS['null_value']) {
                                                                        ...
                                                                        echo html_entity_decode($obj->encode_decode('decrypt', $info['party_name'])); 
                                                                    }  else {
                                                                        echo " - ";
                                                                    }
                                                                }
...
<script type="text/javascript">
    ...
    function PaymentModalContent(bill_id, type) {
        ...
        if (type == 'Receipt') {
            ...
            url = "reports/rpt_expense_a5.php?view_expense_id=" + bill_id;
        } 
