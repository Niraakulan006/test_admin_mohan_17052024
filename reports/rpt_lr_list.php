...
$branch_id =""; $from_date =""; $to_date =""; $bill_type =""; $consignee_id =""; $consignor_id= ""; $organization_id =""; $filter_gst_type = "";
   ...
   if(isset($_REQUEST['filter_gst_type']))
    ...
    foreach($total_records_list as $key => $data) {
        ...
        $pdf->SetX(110);
        $pdf->MultiCell(35,5,$branch_name,0,'C',0);
        $branch_y = $pdf->GetY();
        $pdf->SetY($starty);
        $pdf->SetX(145);
    ...
    $pdf->SetY($y_axis);
    $pdf->SetX(10);
    $pdf->Cell(5,220,'',1,0,'C',0);
    $pdf->SetX(15);
    $pdf->Cell(25,220,'',1,0,'C',0);
    $pdf->SetX(40);
