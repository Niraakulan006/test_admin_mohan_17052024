...
if(isset($_REQUEST['view_expense_id'])) {
    $view_expense_id = $_REQUEST['view_expense_id'];
}
$from = "";
...
$expense_list = array();
$expense_list = $obj->getAllRecords($GLOBALS['expense_table'], 'expense_id', $view_expense_id);

$expense_number = ""; $expense_date = ""; $party_id = ""; $party_name = "";$narration = ""; $amounts = array(); $payment_mode_ids = array(); $payment_mode_names = array(); $bank_ids = array(); 
...
if(!empty($expense_category_name) && $expense_category_name !=$GLOBALS['null_value']){
    $pdf->Cell(85,4,$expense_category_name,0,1,'L');
}
$party_y = $pdf->GetY();
...
$pdf->SetX(110);
$pdf->Cell(40,6,'Expense No ',0,0,'L');
$pdf->SetTextColor(0,0,0);
$pdf->Cell(3,6,':',0,0,'L');
$pdf->Cell(57,6,$expense_number,0,1,'L');
$pdf->SetTextColor(0,130,0);
$pdf->SetX(110);
$pdf->Cell(40,6,'Expense Date ',0,0,'L');
$pdf->SetTextColor(0,0,0);
$pdf->Cell(3,6,':',0,0,'L');
