...
include("../include/number2words.php");
    ...
    $from_branch_id = ""; $to_branch_id = ""; $from_date =""; $to_date =""; $bill_type =""; $consignee_id =""; $consignor_id= ""; $filter_gst_type = "";
    ...
    $lr_list = array();
    $lr_list = $obj->getLRDetailsList('','', $from_branch_id, $to_branch_id,$consignee_id,$consignor_id,$bill_type,'0',$from_date, $to_date,'', $filter_gst_type);
    ...
    $head_y = $pdf->getY();
    $pdf->Cell(0,10,'LR Report',1,1,'C',0);
    $pdf->SetFont('Arial','B',9);
    $pdf->SetX(10);
    ...
    $pdf->SetY($y_axis);
    $pdf->SetX(10);
    $pdf->Cell(5,250,'',1,0,'C',0);
    $pdf->SetX(15);
    $pdf->Cell(25,250,'',1,0,'C',0);
    $pdf->SetX(40);
    $pdf->Cell(35,250,'',1,0,'C',0);
    $pdf->SetX(75);
    $pdf->Cell(35,250,'',1,0,'C',0);
    $pdf->SetX(110);
    $pdf->Cell(35,250,'',1,0,'C',0);
    $pdf->SetX(145);
    $pdf->Cell(20,250,'',1,0,'C',0);
    $pdf->SetX(165);
    $pdf->Cell(20,250,'',1,0,'C',0);
    $pdf->SetX(185);
    $pdf->Cell(15,250,'',1,1,'C',0);
