...
if(!empty($party_type)){
    $lower_case_party_type = strtolower($party_type);
}


$party_list = array();
$party_list = $obj->getTableRecords($GLOBALS[$lower_case_party_type.'_table'], $lower_case_party_type.'_id', $party_id, '');
